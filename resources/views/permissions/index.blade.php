    ...
    <div class="flex justify-between">
      <form action={{ route('permissions.index') }}>
        <div class="flex">
          ...
          <div id="dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 block" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="
                      position: absolute;
            ...
            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
              <li>
                <a href={{ route('permissions.index') }} class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><br></a>
              </li>
              <li>
                <a href={{ route('permissions.index')."?trashed=1" }} class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">With Trashed</a>
              </li>
              <li>
                <a href={{ route('permissions.index')."?onlyTrashed=1" }} class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Only Trashed</a>
              </li>

            </ul>
          </div>
          <div class="relative w-full">
            <input name="keyword" type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-100 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search" value="{{ request()->get('keyword') }}" />
    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg mt-4">
      <div class="flex justify-between items-center pb-4 bg-white dark:bg-gray-900">
        <!-- <div>
          ...
          <div id="dropdownAction" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 block" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="
                      position: absolute;
                      inset: 0px auto auto 0px;
                      margin: 0px;
      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="py-3 px-6">Gaurd</th>
        ...
        <tbody id="content">
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="py-4 px-6">{{ $data->slug }}</td>
            <td class="py-4 px-6">
              <div class="flex items-center">
                {{ $data->guard_name }}
              </div>
            ...
            <td class="py-4 px-6">
              <a href={{ route('permissions.edit', $data->id) }} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
            </td>
          </tr>
          @endforeach
