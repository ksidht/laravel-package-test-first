...
<div class="flex-1 py-9 px-6 mr-6 max-w-2xl">
    <div class="flex justify-between items-center">
        <h2 class="text-3xl font-extrabold dark:text-white my-8">Create Permissions</h2>
        <button
            type="button"
    ...
    <div class="mb-6">
        <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Permission Slug</label>
        <input 
            type="slug" 
            id="slug" 
            name="slug" 
