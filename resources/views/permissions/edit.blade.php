...
<div class="flex-1 py-9 px-6 mr-6 max-w-2xl">
  <div class="flex justify-between items-center">
    <h2 class="text-3xl font-extrabold dark:text-white my-8">Update Permission</h2>
  ...
  <form action={{ route('permissions.update', $permission->id) }} method="post">
    ...
    @method('put')
    <div class="mb-6">
      <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Permission</label>
      <input 
        type="text" 
        id="name" 
        name="name" 
