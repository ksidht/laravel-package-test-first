...
<html lang="en">
  <head>
    ...
    <title>@yield('title', 'Larvel')</title>
      ...
      >
        ...
        >
          ...
          <div class="flex items-center md:order-2">
            ...
            <!-- Dropdown menu -->
            <div
              class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 block"
              id="user-dropdown"
              ...
              style="
                ...
                margin: 0px;
                transform: translate3d(661px, 82px, 0px);
              "
            >
              <div class="py-3 px-4">
            ...
            <ul class="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span class="flex-1 ml-3 whitespace-nowrap">Features</span>
                </a>
              </li>
              <li>
                <a
